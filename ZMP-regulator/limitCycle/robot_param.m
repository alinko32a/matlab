...
th1 = deg2rad(0); th2 = deg2rad(0); th3 = deg2rad(25); th4 = deg2rad(-50); th5 = deg2rad(25); th6 = deg2rad(0);
...
uLINK(JointName.BODY).p = [0.00, 0.00, l1+cos(deg2rad(25))*l3+cos(deg2rad(25))*l4+l6]';
